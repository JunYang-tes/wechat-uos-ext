...
function handlePasteImg(e: ClipboardEvent) {
    ...
    if (textContent) {
      ...
      document.addEventListener(
        ...
        (e) => {
          ...
          if (target?.id === 'textContent' && e.clipboardData) {
            if (e.clipboardData.types[0] === 'Files') {
              handlePasteImg(e)
            } else if (e.clipboardData.types[0].startsWith('text')) {
              // tx 处理的onPaste 太粗糙，不如浏览自己的
              e.stopPropagation();
            }
          }
        },
